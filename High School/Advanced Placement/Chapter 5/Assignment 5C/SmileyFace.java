...
public class SmileyFace implements Comparable {
	...
	/********************************************************************/
	public void smile() {
		if (isSmiling) { 	// if it's already smiling, return
			return;
		}
	...
	public int compareTo(Object o) {
		SmileyFace s = (SmileyFace)o;
		if (getRadius() < s.getRadius()) {
			return -1;
		}
		else if (getRadius() > s.getRadius()) {
			return 1;
		}
		else {
			return 0;
