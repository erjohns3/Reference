...
public class ColorBars extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnDraw) 	{	// draw button clicked
			...
			c = new Color(256, 0, 0);			// instantiate a new color and store it in c
			g.setColor(c);						// set the drawing color c
			g.fillRect(50, 50, 200, 250);			// fill a rectangle on the screen
		}
			...
			g.fillRect(0, 0, 100, 2);			// fill the rectangle (in the background color
		}
	}
